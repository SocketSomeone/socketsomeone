...
export default function TermsPage() {
	return (
		<Page className="py-10 xl-wide:container px-4! xl-wide:px-8! my-8 space-y-4 text-base">
			...
			<section className="space-y-1 text-base">
				<h2 className="text-xl font-semibold">8. External Links and Third-Party Services</h2>
				<p>
			...
			<section className="space-y-1 text-base">
				<h2 className="text-xl font-semibold">9. Accuracy of Materials</h2>
				<p>
			...
			<section className="space-y-1 text-base">
				<h2 className="text-xl font-semibold">12. Entire Agreement</h2>
				<p>
